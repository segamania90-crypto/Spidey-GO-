...
![Spidey GO](screenshots/cover.png)
...
- 🌆 Дұшпандар шексіз пайда болады
- 📱 Мобильді басқару (экрандағы батырмалар арқылы)
...
|------|----------|--------|
| ![menu](screenshots/menu.png) | ![gameplay](screenshots/gameplay.png) | ![combat](screenshots/combat.png) |
